...
Update value in the producer_id column (producer table) where producer_id = 101 and set it to 100.

Then display the movie table and check the changes have propagated properly.
*/
UPDATE
    producer
SET

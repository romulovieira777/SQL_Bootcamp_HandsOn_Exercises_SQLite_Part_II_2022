...
Update value in the rating column (movie table) where movie_id = 2 and set it to 8.

Then display the movie table and check that the changes were made correctly.
*/
UPDATE
    movie
SET

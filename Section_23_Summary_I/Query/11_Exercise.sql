...
Update all values in the due_date column (customer_movie table) and set it to '2021-03-31'.

Then display the customer_movie table. and check if the changes were made correctly.
*/
UPDATE
    customer_movie
SET

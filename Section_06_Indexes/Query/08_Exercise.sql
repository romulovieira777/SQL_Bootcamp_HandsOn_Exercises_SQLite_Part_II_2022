...
Create a query that displays all data for a customer with first name 'Daryl' and the last name 'Spence'. Use the first_name
and last_name columns in the WHERE clause.
*/
SELECT
    *
FROM
    customer
WHERE
    first_name = 'Daryl' AND last_name = 'Spence';
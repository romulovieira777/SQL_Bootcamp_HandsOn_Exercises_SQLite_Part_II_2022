...
Using the query below:
    ...
    SELECT * FROM customer WHERE first_name = 'Daryl';

And the EXPLAIN QUERY PLAN command, check how SQLite filters data in the customer table using the above query.

Expected conclusion: Searching table using index idx_first_name_last_name.

    SEARCH TABLE customer USING INDEX idx_first_name_last_name (first_name = ?)
*/
EXPLAIN QUERY PLAN
SELECT
    *

...
Below is a list of players with ratings (1 - 10 scale) who appeared in the base line-up in a game_id = 1 (player_id, rating):
...
Using the above information, complete the game_player table.
*/
